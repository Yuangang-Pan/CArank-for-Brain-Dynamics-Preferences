...
def doc_load(Training_FFT, Training_RT, Training_ord, Testing_FFT, Testing_RT, Testing_ord):
    ...
    Test_pair = pickle.load(dbfile)
    dbfile.close()

    return Train_FFT, Train_RT, Train_pair, Test_FFT, Test_RT, Test_pair