...
for i in range(Training_FFT.size):
    ...
    scipy.io.savemat('/Regression (C)/Train_score_pres.mat', mdict={'Train_score_pres': Train_score_pres})
    scipy.io.savemat('/Regression (C)/Test_score_pres.mat', mdict={'Test_score_pres': Test_score_pres})
    scipy.io.savemat('/Regression (C)/Acc.mat', mdict={'Acc': Acc})
    scipy.io.savemat('/Regression (C)/RMSE.mat', mdict={'RMSE': RMSE})
