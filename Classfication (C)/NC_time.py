...
for iter in range(Iteration):
    ...
    for i in range(1):
        ...
        for e in range(Num_epoch):
            e_losses += train_epoch(Train_Feat, Train_ord_id, Train_eql_id, model, optimizer, criterion, flag_cuda,
                                    Batch_size, e)
...
#scipy.io.savemat('/home/yuangang/Downloads/BCI_Experiment/Naive_Classfication/computation_cost.mat',
